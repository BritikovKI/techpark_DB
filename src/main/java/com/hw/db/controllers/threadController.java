...
// TODO: Это нихера не оптимально надо препСтатемент
// Доработать запрос на создание поста
// Нужно после проверки на слаг или ID вставлять референсы на форум и на поток в пост
